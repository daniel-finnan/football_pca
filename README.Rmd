...
The data has been scraped from an online source using Python, with code available in the [scraping folder](https://github.com/daniel-finnan/README.pdf) of this repository.

This analysis is also available in [pdf format](https://github.com/daniel-finnan/football_pca/README.pdf).
...
We must decide on the number of principal components, $m$, to retain. There's lots written on this part of the PCA methodology, so we'll refer to an authority on the subject.
