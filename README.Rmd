...
The data has been scraped from an online source using Python, with code available in the [scraping folder](https://github.com/daniel-finnan/scraping/README.md) of this repository.
